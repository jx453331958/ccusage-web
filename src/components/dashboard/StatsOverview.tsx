  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
      <Card className="min-w-0 overflow-hidden">
        ...
        <CardContent>
          <div className="text-xl xl:text-lg 2xl:text-2xl font-bold truncate" title={formatNumber(stats.totalTokens)}>{formatNumber(stats.totalTokens)}</div>
      ...
      <Card className="min-w-0 overflow-hidden">
        ...
        <CardContent>
          <div className="text-xl xl:text-lg 2xl:text-2xl font-bold truncate" title={formatNumber(stats.totalInput)}>{formatNumber(stats.totalInput)}</div>
      ...
      <Card className="min-w-0 overflow-hidden">
        ...
        <CardContent>
          <div className="text-xl xl:text-lg 2xl:text-2xl font-bold truncate" title={formatNumber(stats.totalOutput)}>{formatNumber(stats.totalOutput)}</div>
      ...
      <Card className="min-w-0 overflow-hidden">
        ...
        <CardContent>
          <div className="text-xl xl:text-lg 2xl:text-2xl font-bold truncate" title={formatNumber(stats.totalRecords)}>{formatNumber(stats.totalRecords)}</div>
      ...
      <Card className="min-w-0 overflow-hidden">
        ...
        <CardContent>
          <div className="text-xl xl:text-lg 2xl:text-2xl font-bold truncate" title={formatNumber(stats.totalCacheCreate)}>{formatNumber(stats.totalCacheCreate)}</div>
      ...
      <Card className="min-w-0 overflow-hidden">
        ...
        <CardContent>
          <div className="text-xl xl:text-lg 2xl:text-2xl font-bold truncate" title={formatNumber(stats.totalCacheRead)}>{formatNumber(stats.totalCacheRead)}</div>
